...
public class main {
    ...
    private int [] kruskaluj(int pocet) {
        // setřídí nejprve list dle ohodnocení hran od nejmenší po největší
        setridlist();
        ...
        // vrací výslednou kostru dle správného indexování
    ...
    public static void main(String[] args) throws IOException {
        ...
        String k ;
        if (( k= bi.readLine())!= null)
        {
        String [] l = k.split(" ");
         int pocet = Integer.parseInt(l[0]);
         int pocetvariant = Integer.valueOf(l[1]);
         main krus = new main(pocet);
         for(int i=0;i< pocetvariant;i++)
         {
             k =bi.readLine();
             l = k.split(" ");
            krus.pridejHrany(Integer.valueOf(l[0]), Integer.valueOf(l[1]
                ), Integer.valueOf(l[2]), Integer.valueOf(l[3]), i);
         }
